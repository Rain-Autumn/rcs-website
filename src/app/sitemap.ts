...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    ...['fr', 'en', 'nl'].map((locale) => ({ url: `${base}/${locale}/research`, changeFrequency: 'weekly' as const, priority: 0.9 })),
    ...['fr', 'en', 'nl'].map((locale) => ({ url: `${base}/${locale}/team`, changeFrequency: 'monthly' as const, priority: 0.8 })),
  ];
}
