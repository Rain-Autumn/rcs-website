...
export async function generateMetadata({
  ...
  return {
    ...
    description: copy.metadataDescription,
    alternates: {
      canonical: `/${locale}/evidence-engine`,
      languages: {
        "fr-BE": "/fr/evidence-engine",
        en: "/en/evidence-engine",
        "nl-BE": "/nl/evidence-engine",
        "x-default": "/en/evidence-engine",
      },
    },
    ...social,
  };
